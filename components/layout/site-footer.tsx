  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#0b0f14] px-4 pb-28 pt-16 text-stone-300 sm:px-8 sm:pb-14 lg:px-10">
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.75fr_0.9fr_1fr]">
          <div className="min-w-0">
            <AyyiTourLogo className="h-24 w-24" />
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-gold">Services</p>
