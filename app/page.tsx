    ...
    <main className="min-h-screen bg-obsidian text-ivory">
      ...
      <section className="relative min-h-[92vh] overflow-hidden pt-24">
        <Image
          ...
          alt="Flotte de transport VIP devant un hotel premium"
          fill
          priority
          sizes="100vw"
          className="object-cover object-center"
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,5,5,0.98)_0%,rgba(5,5,5,0.86)_34%,rgba(5,5,5,0.42)_68%,rgba(5,5,5,0.2)_100%)]" />
        <div className="absolute inset-x-0 bottom-0 h-36 bg-gradient-to-t from-obsidian to-transparent" />

        <div className="relative z-10 mx-auto flex min-h-[calc(92vh-6rem)] max-w-7xl items-center px-6 py-16 sm:px-8 lg:px-10">
          <div className="max-w-3xl">
            <div className="mb-8 inline-flex items-center gap-3 border border-gold/35 bg-black/45 px-4 py-2 text-xs font-semibold uppercase tracking-[0.32em] text-gold">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/services"
                className="inline-flex h-13 items-center justify-center gap-3 bg-gold px-6 text-sm font-bold uppercase tracking-[0.18em] text-black transition hover:bg-champagne"
              >
                Voir les services
              ...
              <Link
                ...
                className="inline-flex h-13 items-center justify-center border border-white/20 px-6 text-sm font-bold uppercase tracking-[0.18em] text-white transition hover:border-gold hover:text-gold"
                target="_blank"
            ...
            <div className="mt-12 grid max-w-2xl grid-cols-3 border-y border-white/15">
              {stats.map((item) => (
                <div key={item.label} className="px-4 py-5 first:pl-0">
                  <p className="text-2xl font-semibold text-gold">{item.value}</p>
                  <p className="mt-1 text-xs uppercase tracking-[0.16em] text-stone-300">
                    {item.label}
                  </p>
                </div>
              ))}
      ...
      <section className="bg-obsidian px-6 py-24 sm:px-8 lg:px-10">
      ...
      <section className="bg-ivory px-6 py-24 text-obsidian sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
            eyebrow="Services"
      ...
      <section className="bg-[#11100e] px-6 py-24 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
