  ...
  return (
    <>
      <Link
        ...
        className="fixed bottom-24 right-4 z-40 hidden h-14 w-14 items-center justify-center rounded-full border border-gold/40 bg-[#11100e]/90 text-gold shadow-[0_18px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl transition hover:-translate-y-1 hover:bg-gold hover:text-black sm:inline-flex"
      >
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-gold/25 bg-black/88 px-4 py-3 shadow-[0_-18px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:hidden">
        <div className="grid grid-cols-[1fr_auto] gap-3">
          ...
          <Link
            ...
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="inline-flex h-12 w-12 items-center justify-center border border-gold/35 text-gold"
          >
